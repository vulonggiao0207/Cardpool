<%@ Page Language="C#" AutoEventWireup="true" CodeFile="how-to-sell-gift-cards.aspx.cs" Inherits="how_to_sell_gift_cards" %>
...
<li>
<a class="" href="how-to-buy-gift-cards.aspx">Buying Gift Cards</a></li>
<li>
<a class="selected" href="how-to-sell-gift-cards.aspx">Selling Gift Cards</a></li>
</ul>
</div>
<div class="right">
<ul>
<li>
<a class="" href="contact.html">Contac Us</a></li>
</ul>
</div>
</div>
<div style="margin: 0 10px;">
<h2>How do I sell my gift cards?</h2>
<hr>
<p>
Simply head over to our
<a href="/sell-gift-cards">sell gift cards</a>
section to get started. We'll give you a
<strong>FREE SHIPPING LABEL</strong>
for sending in your gift cards and we'll mail you a check within 24 hours of receiving your gift cards. With our new instant redemption option, in many cases you may even be able to sell your gift card electronically with no mailing required!
</p>
<h2>How do I know I'll receive payment after sending you my gift cards?</h2>
<hr>
<p>
Great question! In 2011
<a href="/cardpool-has-been-acquired-by-blackhawk-network">Cardpool was acquired by Blackhawk Network</a>
, a subsidiary of
<a href="http://www.safeway.com">Safeway, Inc.</a>
, a large and trusted public company on the New York Stock Exchange (Ticker: SWY). We've also received glowing reviews from CNN, NBC, ABC, CBS, FOX, NPR, The New York Times, The Wall Street Journal, and many other highly reputable publications, and our original investors include the founders, CEOs, and investors responsible for many of the brands we've come to love including Google, Facebook, PayPal, Zappos, StubHub, Twitter, Skype, Slide, Lotus, Mint, and many others. We were only able to accomplish this by maintaining the highest level of standards and integrity.
</p>
If you'd like to learn more, read about us
<a href="/press">in the news</a>
and learn more
<a href="/about">about us</a>
.
<p></p>
<h2>What kind of shipping should I use to ship my gift cards to you?</h2>
<hr>
<p>
For your convenience, we'll provide you a
<strong>FREE SHIPPING LABEL</strong>
so all you have to do is drop your cards off in the mail! If you'd prefer to use your own method of shipping, we recommend using USPS First Class Mail, USPS Priority, or USPS Certified Mail. With our new instant redemption option, in many cases you may even be able to sell your gift card electronically with no mailing required!
</p>
<h2>How long does it take to get paid?</h2>
<hr>
<p> Once we receive your gift cards, we usually process them, verify their values, and issue payment within one business day. The check is sent via USPS First Class mail which typically takes 3-7 business days to reach its final destination. </p>
<h2>Do you accept store credit?</h2>
<hr>
<p>
Yes, you can get cashback for merchandise credit provided that the credit is in the form of a plastic card and never expires. Just treat the store credit card as a gift card when
<a href="/sell-gift-cards">selling your gift cards</a>
.
</p>
</div>
</div>
      ...
      <table class="layout">
        <tbody><tr>
          <td style="vertical-align: top; padding-right: 20px; width: 200px;">
            ...
            <hr>
            <form action="https://www.cardpool.com/login_api.json" class="login_form display_form_errors_inline" method="post">
            <div style="margin:0;padding:0;display:inline"><input name="authenticity_token" value="pHzpAzpbCzETmLdiy1xIJtgZwyrW10/5hfboKI0TMU8=" type="hidden"></div>              <div class="flashes">
