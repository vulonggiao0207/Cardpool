        ...
        <tbody><tr>
          ...
          <td style="vertical-align: middle; width: 50%;">
            ...
            <div class="slogan" style="margin: 5px;">
              <a href="how-it-works.aspx" class="ga_track_event:category=clicks:action=how_it_works:opt_label=header">Free Shipping and 100-Day Purchase Guarantee</a><br>
            </div>
          </td>
...
<div id="front_page" class="span-24 last">
  <div class="raised_box">
    ...
    <div class="box_middle_right"><div class="box_middle_left"><div class="content">
      <div style="margin: 2px 10px 10px 10px;">
        <h1 style="margin-bottom: 12px;">Welcome to Cardpool - The Easiest Way to Buy and Sell Gift Cards</h1>
        <h2 class="secondary_header" style="margin: 0;">Buy gift cards for up to 35% off or sell gift cards for up to 92% cash back.</h2>
      </div>
      <table class="giftcards_big_grid ">
        
        
        <tbody><tr>
        
          <td>
              <asp:ImageButton ID="CardImage11" runat="server" Height="79px" 
                  ImageUrl="~/images/CardImages/no_images.jpg" onclick="CardImage_Click" 
                  PostBackUrl="#" Width="125px" />
            </td>
        
        
        
          <td>
              <asp:ImageButton ID="CardImage0" runat="server" Height="79px" 
                  ImageUrl="~/images/CardImages/no_images.jpg" onclick="CardImage0_Click" 
                  PostBackUrl="#" Width="125px" />
            </td>
          ...
          <td>
              <asp:ImageButton ID="CardImage1" runat="server" Height="79px" 
                  ImageUrl="~/images/CardImages/no_images.jpg" onclick="CardImage1_Click" 
                  PostBackUrl="#" Width="125px" />
            </td>
          ...
          <td>
              <asp:ImageButton ID="CardImage2" runat="server" Height="79px" 
                  ImageUrl="~/images/CardImages/no_images.jpg" onclick="CardImage2_Click" 
                  PostBackUrl="#" Width="125px" />
            </td>
          ...
          <td>
              <asp:ImageButton ID="CardImage3" runat="server" Height="79px" 
                  ImageUrl="~/images/CardImages/no_images.jpg" onclick="CardImage3_Click" 
                  PostBackUrl="#" Width="125px" />
            </td>
          ...
          <td>
              <asp:ImageButton ID="CardImage4" runat="server" Height="79px" 
                  ImageUrl="~/images/CardImages/no_images.jpg" onclick="CardImage4_Click" 
                  PostBackUrl="#" Width="125px" />
            </td>
        ...
        <tr>
          ...
          <td>
              <asp:ImageButton ID="CardImage5" runat="server" Height="79px" 
                  ImageUrl="~/images/CardImages/no_images.jpg" onclick="CardImage5_Click" 
                  PostBackUrl="#" Width="125px" />
            </td>
          ...
          <td>
              <asp:ImageButton ID="CardImage6" runat="server" Height="79px" 
                  ImageUrl="~/images/CardImages/no_images.jpg" onclick="CardImage6_Click" 
                  PostBackUrl="#" Width="125px" />
            </td>
          ...
          <td>
              <asp:ImageButton ID="CardImage7" runat="server" Height="79px" 
                  ImageUrl="~/images/CardImages/no_images.jpg" onclick="CardImage7_Click" 
                  PostBackUrl="#" Width="125px" />
            </td>
          ...
          <td>
              <asp:ImageButton ID="CardImage8" runat="server" Height="79px" 
                  ImageUrl="~/images/CardImages/no_images.jpg" onclick="CardImage8_Click" 
                  PostBackUrl="#" Width="125px" />
            </td>
          ...
          <td>
              <asp:ImageButton ID="CardImage9" runat="server" Height="79px" 
                  ImageUrl="~/images/CardImages/no_images.jpg" onclick="CardImage9_Click" 
                  PostBackUrl="#" Width="125px" />
            </td>
          ...
          <td>
              <asp:ImageButton ID="CardImage10" runat="server" Height="79px" 
                  ImageUrl="~/images/CardImages/no_images.jpg" onclick="CardImage10_Click" 
                  PostBackUrl="#" Width="125px" />
            </td>
        </tr>
      </tbody></table>
      ...
      <table class="layout">
        <tbody><tr>
          <td style="padding-left: 5px;">
            <asp:Button ID="BuyGiftButton" runat="server" Text="Buy Gift Cards" 
                 Width="150px" BackColor="#009900" Font-Bold="True" Font-Size="12pt" 
                   ForeColor="White" Height="35px" PostBackUrl="~/buy-gift-cards.aspx" /></td>
          <td style="padding-left: 20px;">
            <asp:Button ID="SellGiftButton" runat="server" Text="Sell Gift Cards"
             Width="150px" BackColor="#009900" Font-Bold="True" Font-Size="12pt" 
                   ForeColor="White" Height="35px" PostBackUrl="~/sell-gift-cards.aspx"  />
          </td>
          <td style="width: 100%; text-align: center; vertical-align: middle;">
            <h4 class="bottom">
              All orders include <strong>FREE SHIPPING</strong> and are <strong>GUARANTEED</strong>.  
              <a href="http://www.cardpool.com/support/how-it-works" class="learn_more ga_track_event:category=clicks:action=how_it_works:opt_label=main_button" style="padding-left: 10px;">Learn More</a>
            </h4>
          </td>
        </tr>
      </tbody></table>
  ...
  <a href="http://www.cardpool.com/press"><img alt="Press_bar" 
          src="images/press_bar.png"></a>
...
<div class="span-8">
  <div class="raised_box">
    ...
    <div class="box_middle_right"><div class="box_middle_left"><div class="content">
      ...
      <hr>
      <p>Buy discount gift cards to all your favorite stores for up to 35% off at our gift card exchange.  Free shipping on all orders.</p>
      <div style="text-align: right;">
        <p class="bottom"><a href="http://www.cardpool.com/buy-gift-cards" class="learn_more ga_track_event:category=clicks:action=buy:opt_label=secondary_button">Buy Discount Gift Cards</a></p>
      </div>
    </div></div></div>
    <div class="box_bottom_right"><div class="box_bottom_left"><!-- ie_hack: ie6 sucks --></div></div>
  </div>
...
<div class="span-8">
  <div class="raised_box">
    ...
    <div class="box_middle_right"><div class="box_middle_left"><div class="content">
      ...
      <hr>
      <p>Sell your gift cards for cash and earn up to 92% cash back at our gift card exchange. Free shipping on all transactions.</p>
      <div style="text-align: right;">
        <p class="bottom"><a href="http://www.cardpool.com/sell-gift-cards" class="learn_more ga_track_event:category=clicks:action=sell:opt_label=secondary_button">Sell Gift Cards For Cash</a></p>
      </div>
    </div></div></div>
    <div class="box_bottom_right"><div class="box_bottom_left"><!-- ie_hack: ie6 sucks --></div></div>
  </div>
...
<div class="span-8 last">
  <div class="raised_box">
    ...
    <div class="box_middle_right"><div class="box_middle_left"><div class="content">
      <h3>Bulk Sales</h3>
      <hr>
      <p>Selling more than $5,000 in gift cards? Call our Bulk Sales department Mon-Fri, 9am-6pm PST at (800) 240-6188.</p>  
      <div style="text-align: right;">
        <p class="bottom"><a href="http://www.cardpool.com/bulk-seller-program" class="learn_more ga_track_event:category=clicks:action=how_it_works:opt_label=secondary_button">Learn About Bulk Sales</a></p>
      </div>
    </div></div></div>
    <div class="box_bottom_right"><div class="box_bottom_left"><!-- ie_hack: ie6 sucks --></div></div>
  </div>
...
<div class="span-24 last">
  <div class="raised_box_with_header">
    <div class="box_top_right"><div class="box_top_left"><div class="header">About Cardpool</div></div></div>
    <div class="box_middle_right"><div class="box_middle_left"><div class="content">
      <p>
        Cardpool makes it ridiculously easy to buy and sell pre-owned gift cards. 
        Customers can buy gift cards for up to 35% off or sell unwanted gift cards for cash.
        By connecting all the gift card holders around the world into one trusted gift card exchange marketplace, 
        we are able to help everyone get exactly what they want, whether its a discounted gift card, a different
        gift card, or simply cash.
      </p>
      <p>
        Interested?  Browse our
        <a href="http://www.cardpool.com/buy-gift-cards">discounted gift cards</a>,
        earn cash by <a href="http://www.cardpool.com/sell-gift-cards">selling gift cards</a> for cash, 
        or learn more about <a href="http://www.cardpool.com/support/how-it-works">how it works</a>,
        and see why CNN, NBC, ABC, CBS, FOX, The New York Times, and 
others are calling us "the gift card marketplace everyone should be 
using."
      </p>
      <h4>Popular Discounted Gift Cards</h4>
      <table class="bottom">
        ...
        <tbody><tr>
          ...
          <td style="width: 20%; padding: 3px;">
            <a href="http://www.cardpool.com/buy/best-buy-gift-cards">Best Buy Gift Cards</a>
          </td>
        
        
        
          <td style="width: 20%; padding: 3px;">
            <a href="http://www.cardpool.com/buy/cardpool-gift-cards">Cardpool Gift Cards</a>
          </td>
        
        
        
          <td style="width: 20%; padding: 3px;">
            <a href="http://www.cardpool.com/buy/home-depot-gift-cards">Home Depot Gift Cards</a>
          </td>
        
        
        
          <td style="width: 20%; padding: 3px;">
            <a href="http://www.cardpool.com/buy/jcpenney-gift-cards">JCPenney Gift Cards</a>
          </td>
        
        
        
          <td style="width: 20%; padding: 3px;">
            <a href="http://www.cardpool.com/buy/kohls-gift-cards">Kohl's Gift Cards</a>
          </td>
        ...
        <tr>
          ...
          <td style="width: 20%; padding: 3px;">
            <a href="http://www.cardpool.com/buy/lowes-gift-cards">Lowe's Gift Cards</a>
          </td>
        
        
        
          <td style="width: 20%; padding: 3px;">
            <a href="http://www.cardpool.com/buy/macys-gift-cards">Macy's Gift Cards</a>
          </td>
        
        
        
          <td style="width: 20%; padding: 3px;">
            <a href="http://www.cardpool.com/buy/target-gift-cards">Target Gift Cards</a>
          </td>
        
        
        
          <td style="width: 20%; padding: 3px;">
            <a href="http://www.cardpool.com/buy/victorias-secret-gift-cards">Victoria's Secret Gift Cards</a>
          </td>
        
        
        
          <td style="width: 20%; padding: 3px;">
            <a href="http://www.cardpool.com/buy/walmart-gift-cards">Walmart Gift Cards</a>
          </td>
