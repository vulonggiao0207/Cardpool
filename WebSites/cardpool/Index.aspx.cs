...
public partial class Index : System.Web.UI.Page
{
    ...
    #region CardImage_Click
    protected void CardImage_Click(object sender, ImageClickEventArgs e)
    {
        
    }
    protected void CardImage0_Click(object sender, ImageClickEventArgs e)
    {

    }
    protected void CardImage1_Click(object sender, ImageClickEventArgs e)
    {

    }
    protected void CardImage2_Click(object sender, ImageClickEventArgs e)
    {

    }
    protected void CardImage3_Click(object sender, ImageClickEventArgs e)
    {

    }
    protected void CardImage4_Click(object sender, ImageClickEventArgs e)
    {

    }
    protected void CardImage5_Click(object sender, ImageClickEventArgs e)
    {

    }
    protected void CardImage6_Click(object sender, ImageClickEventArgs e)
    {

    }
    protected void CardImage7_Click(object sender, ImageClickEventArgs e)
    {

    }
    protected void CardImage8_Click(object sender, ImageClickEventArgs e)
    {

    }
    protected void CardImage9_Click(object sender, ImageClickEventArgs e)
    {

    }
    protected void CardImage10_Click(object sender, ImageClickEventArgs e)
    {
