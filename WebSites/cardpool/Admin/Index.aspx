<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Index.aspx.cs" Inherits="how_it_works" %>
...
<!-- END vavigator-->  
   ...
   <table class="style1" 
             ...
             style="width: 300px; height: 60px; border: medium groove #68A0E7; margin: 100px auto 100px auto; background-color: #FFFFFF;">
          <tr>
              <td>
              <center>
                  <table>
                      <tr>
                          <td>
                          <center>
                              <asp:Label ID="NameLabel" runat="server" Font-Size="12pt"></asp:Label>
                          </center>
                          </td>
                      </tr>
                      <tr>
                          <td class="style2">
                          <center>
                              <asp:HyperLink ID="ChangPasswordHyperLink" runat="server" Font-Size="12pt" 
