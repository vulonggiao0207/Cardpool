<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Manage-user.aspx.cs" Inherits="how_it_works" %>
...
<!-- END vavigator-->  
   ...
   <table class="style1" style="width: 390px; height: 110px; border: medium groove #68A0E7; margin: 100px auto 100px auto; background-color: #FFFFFF;">
          <tr>
              <td>
              <asp:Panel ID="MainPanel" runat="server">
                  <table style="width: 0px" id="Maintb">
                      <tr>
                          <td colspan="3">
                              <hr style="margin: 0px" />
                              <h2 style="margin: 0px">
                      ...
                      <tr>
                          <td>
                              <asp:Label ID="Label1" runat="server" Font-Size="12pt" Text="ID:"></asp:Label>
                          </td>
                          <td class="style4">
                              <asp:TextBox ID="IDTextBox" runat="server" Font-Size="12pt"></asp:TextBox>
                          </td>
                          <td class="style2" style="width: 390px">
                              <asp:Button ID="AddnewuserButton" runat="server" Font-Size="12pt" 
                                  Text="Add New User" onclick="AddnewuserButton_Click" />
                          </td>
                      </tr>
                      <tr>
                          <td>
                          ...
                          <td class="style4">
                              <asp:TextBox ID="PasswordTextBox" runat="server" Font-Size="12pt" 
                      ...
                      <tr>
                          ...
                          <hr style="margin: 0px"/>
                          <center>
                              <asp:GridView ID="AdminGridview" runat="server" AutoGenerateColumns="False" 
                                  DataKeyNames="AdID" DataSourceID="AdminSource" Font-Size="12pt" 
                                  Width="380px" AutoGenerateDeleteButton="True" CellPadding="4" 
                                  ForeColor="#333333" GridLines="None" 
                                  onrowdeleting="AdminGridview_RowDeleting" ShowFooter="True">
                              ...
                              <asp:SqlDataSource ID="AdminSource" runat="server" 
                                  ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                                  DeleteCommand="Delete from Admin WHERE AdID=@AdID"                               
                                  SelectCommand="SELECT AdID FROM Admin WHERE (Super = 0)"  >                                
                                  <DeleteParameters>
                      ...
                      <center>
                              <asp:Label ID="ErrorTextBox" runat="server" Font-Bold="False" 
                                  Font-Size="11pt" ForeColor="Red" Text="You have no right to manage user" 
