<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Manage-gift-card.aspx.cs" Inherits="how_it_works" %>
...
<!-- END vavigator-->  
   ...
   <table class="style1" 
             ...
             style="width: 300px; height: 110px; border: medium groove #68A0E7; margin: 100px auto 100px auto; background-color: #FFFFFF;">
          <tr>
              <td>
                  <table style="width: 270px">
                      <tr>
                          <td>
                              <asp:Button ID="CategoryButton" runat="server" BackColor="#68A0E7" 
                                  Font-Bold="True" Font-Size="12pt" ForeColor="White" 
                                  Text="Manage Category" Width="260px" onclick="CategoryButton_Click" />
                          </td>
                      </tr>
                      <tr>
                          <td>
                              <asp:Button ID="MerchantButton" runat="server" BackColor="#68A0E7" 
                                  Font-Bold="True" Font-Size="12pt" ForeColor="White" 
                                  Text="Manage Merchant" Width="260px" onclick="MerchantButton_Click" />
                          </td>
                      </tr>
                      <tr>
                          <td>
                              <asp:Button ID="MerchantDetailsButton" runat="server" BackColor="#68A0E7" 
                                  Font-Bold="True" Font-Size="12pt" ForeColor="White" 
                                  Text="Manage Merchant Details" Width="260px" 
                                  onclick="MerchantDetailsButton_Click" />
                          </td>
                      </tr>
                      </table>
              </td>
