<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Merchant.aspx.cs" Inherits="how_it_works" %>
...
<body>
  ...
  <div id="main_nav" class="span-24 last">
	...
	<li><a href="Manage-Orders.aspx">Manager Order </a>&nbsp;</ul>
<!-- END vavigator-->  
   ...
   <table class="style1" style="width: 940px; height: 110px; border: medium groove #68A0E7; margin: 100px auto 100px auto; background-color: #FFFFFF;">
          <tr>
              <td>
                  <table class="style1" style="width: 930px">
                      <tr>
                          <td colspan="2">
                          <hr style="margin: 0px" />
                            <h2 style="margin: 0px">Merchant</h2>
                          <hr style="margin: 0px" />
                              </td>
                      </tr>
                      <tr>
                          <td colspan="2">
                              <asp:Label ID="Label1" runat="server" Font-Size="12pt" Text="Category:  "></asp:Label>
                              <asp:DropDownList ID="CategoryDropDownList" runat="server" Font-Size="12pt" 
                      ...
                      <tr>
                          <td>
                              <asp:Button ID="AddMerchantButton" runat="server" Font-Size="12pt" 
                                  onclick="AddMerchantButton_Click" Text="Add new merchant..." />
                          </td>
                          <td>
                              &nbsp;</td>
                      </tr>
                      <tr>
                          <td colspan="2">                          
                                      <asp:GridView ID="MerchantGridView" runat="server" Font-Size="12pt" 
                                          Width="900px" AllowPaging="True" AutoGenerateColumns="False" 
                                          AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" CellPadding="4" 
                                          DataKeyNames="CardID"                                         
                                          onpageindexchanging="MerchantGridView_PageIndexChanging" 
                                          ShowHeaderWhenEmpty="True" 
                                          onrowcancelingedit="MerchantGridView_RowCancelingEdit" 
                                          onrowcreated="MerchantGridView_RowCreated" 
                                          onrowdeleting="MerchantGridView_RowDeleting" 
                                          onrowediting="MerchantGridView_RowEditing" 
                                          onrowupdating="MerchantGridView_RowUpdating" PageSize="5" 
                                          ...
                                          <Columns>
                                              <asp:TemplateField HeaderText="Name">
                                                  <ItemTemplate>
                                                              ...
                                                              <asp:Label ID="CardNameTextBox" runat="server" Font-Size="12pt" Height="50px" 
                                                                  Text='<%# Eval("CardName") %>' Width="150px"></asp:Label>
                                                        
                                                  </ItemTemplate>
                                                  <EditItemTemplate>
                                                    
                                                              <asp:TextBox ID="CardNameTextBox" runat="server" Font-Size="12pt" Height="50px" 
                                                                  Text='<%# Eval("CardName") %>' TextMode="MultiLine" Width="150px"></asp:TextBox>
                                              ...
                                              <asp:TemplateField HeaderText="Category">
                                                  <EditItemTemplate>                                                      
                                                              <asp:DropDownList ID="CatDropDownList" runat="server" Font-Size="12pt" 
                                                                  Width="160px">
                                                              </asp:DropDownList>                                                      
                                                  </EditItemTemplate>
                                                  <ItemTemplate>
                                                  
                                                              <asp:DropDownList ID="CatDropDownList" runat="server" BackColor="White" 
                                                                  Enabled="False" Font-Size="12pt" Width="160px">
                                                              </asp:DropDownList>
                                                        
                                                  </ItemTemplate>
                                                  <ItemStyle Width="160px" />
                                              </asp:TemplateField>
                                              <asp:TemplateField HeaderText="Deccription">
                                                  <ItemTemplate>
                                                    
                                                              <asp:TextBox ID="DescriptionTextBox" runat="server" Font-Size="12pt" 
                                                                  Height="150px" ReadOnly="True" Text='<%# Eval("Description") %>' 
                                                                  TextMode="MultiLine" Width="170px" BorderStyle="None"></asp:TextBox>
                                                       
                                                  </ItemTemplate>
                                                  <EditItemTemplate>                                                    
                                                              <asp:TextBox ID="DescriptionTextBox" runat="server" Font-Size="12pt" 
                                                                  Height="150px" Text='<%# Eval("Description") %>' TextMode="MultiLine" 
                                              ...
                                              <asp:TemplateField HeaderText="Image">
                                                  <EditItemTemplate>
                                                      <asp:AsyncFileUpload ID="CardImage" runat="server" Width="200px" />
                                                  </EditItemTemplate>
                                                  <ItemTemplate>
                                                      <asp:Image ID="CardImage" runat="server" Height="100px" Width="180px" 
                                                          ImageUrl='<%# Eval("Image") %>' ImageAlign="Middle" />
                                                  </ItemTemplate>
                                                  <ItemStyle Width="200px" />
                                              </asp:TemplateField>
                                              <asp:BoundField DataField="CardID" HeaderText="CardID" Visible="False" />
                                          </Columns>
                      ...
                      <tr>
                          <td>
                              <asp:Button ID="AddMerchantButton2" runat="server" Font-Size="12pt" 
                                  onclick="AddMerchantButton_Click" Text="Add new merchant..." 
                                  OnClientClick="$find('bePopup').show();return false;"/>
                              
                              <asp:Panel ID="Panel1" runat="server" BorderColor="#68A0E7" BorderStyle="Solid" 
                                  BorderWidth="5px" Width="400px" BackColor="LightGray" Style="display: none">
                                  <table class="style1">
                                      <tr>
                                          <td colspan="3">
                                            <hr style="margin: 0px" />
                                             <h2 style="margin: 0px">Add new merchant</h2>
                                             <hr style="margin: 0px" />
                                          </td>
                                      </tr>
                                      <tr>
                                          <td class="style3">
                                              <asp:Label ID="Label2" runat="server" Font-Size="12pt" Text="Name:"></asp:Label>
                                          </td>
                                          <td colspan="2">
                                              <asp:TextBox ID="AddNameTextBox" runat="server" Font-Size="12pt" Width="220px"></asp:TextBox>
                                          </td>
                                      </tr>
                                      <tr>
                                          <td class="style3">
                                              <asp:Label ID="Label3" runat="server" Font-Size="12pt" Text="Category:"></asp:Label>
                                          </td>
                                          <td colspan="2">
                                              <asp:DropDownList ID="AddCategoryDropDown" runat="server" Font-Size="12pt" 
                                                  Width="220px">
                                              </asp:DropDownList>
                                          </td>
                                      </tr>
                                      <tr>
                                          <td class="style3">
                                              <asp:Label ID="Label4" runat="server" Font-Size="12pt" Text="Description:"></asp:Label>
                                          </td>
                                          <td colspan="2" rowspan="3">
                                              <asp:TextBox ID="AddDescriptionTextBox" runat="server" Font-Size="12pt" 
                                                  Height="150px" TextMode="MultiLine" Width="220px"></asp:TextBox>
                                          </td>
                                      </tr>
                                      <tr>
                                          <td class="style3">
                                      ...
                                      <tr>
                                          ...
                                          <td colspan="2">
                                              <asp:AsyncFileUpload ID="AddImageFileUpLoad" runat="server" Width="219px" />
                                          </td>
                                      </tr>
                                      <tr>
                                          <td class="style3">
                                              &nbsp;</td>
                                          <td class="style4">
                                              <asp:Button ID="OKButton" runat="server" Font-Size="12pt" Text="OK" 
                                                  onclick="OKButton_Click" />
                                          </td>
                                          <td class="style5">
                                              <asp:Button ID="CancelButton" runat="server" Font-Size="12pt" Text="Cancel"/>
                                          </td>
                                      </tr>
                                  </table>
                              </asp:Panel>
                              ...
                              <asp:ModalPopupExtender ID="ModalPopupExtender2" runat="server"
                               DropShadow="True"
                               PopupControlID="Panel1" TargetControlID="AddMerchantButton" 
                               BackgroundCssClass="modalBackground" BehaviorID="bePopup"></asp:ModalPopupExtender>
    ...
    <div id="footer" class="span-24 last">
      <div>
        <a href="http://www.cardpool.com/about">About Us>|</span> 
