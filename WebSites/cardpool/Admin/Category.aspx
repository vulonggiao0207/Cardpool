<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Category.aspx.cs" Inherits="how_it_works" %>
...
<!-- END vavigator-->  
   ...
   <table style="width: 900px; height: 110px; border: medium groove #68A0E7; margin: 100px auto 20px auto; background-color: #FFFFFF;">
          <tr>
              <td>
                  <table style="width: 890px">
                      ...
                      <tr>
                          <td class="style4" bgcolor="#68A0E7">
                              <asp:Label ID="Label1" runat="server" Font-Size="12pt" Text="Name:"></asp:Label>
                          </td>
                          <td class="style4" bgcolor="#68A0E7">
                              <asp:TextBox ID="CatNameTextBox" runat="server" Height="24px" Width="150px" 
                                  Font-Size="12pt"></asp:TextBox></td>
                          <td class="style4" bgcolor="#68A0E7">
                              <asp:Label ID="Label2" runat="server" Font-Size="12pt" Text="Image:"></asp:Label>
                          </td>
                          <td class="style4" bgcolor="#68A0E7">
                              <asp:AsyncFileUpload ID="CatImageFileUp" runat="server" Width="220px" />
                          </td>
                          <td class="style4" bgcolor="#68A0E7">
                              <asp:Label ID="Label3" runat="server" Font-Size="12pt" Text="Description:"></asp:Label>
                          </td>
                          <td class="style4" rowspan="2" bgcolor="#68A0E7">
                              <asp:TextBox ID="CatDescriptionTextBox" runat="server" Height="100px" TextMode="MultiLine" 
                                  Width="150px" Font-Size="12pt"></asp:TextBox>
                          </td>
                          <td bgcolor="#68A0E7">
                              
                              <asp:Button ID="AddCatButton" runat="server" Text="Add" Font-Size="12pt" style="margin-right: 0px" 
                          ...
                          <hr style="padding: 0px; margin: 0px" />
                              ...
                              <asp:GridView ID="CategoryGridView" runat="server" AutoGenerateColumns="False" 
                                  AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" 
                                     Font-Size="12pt" CellPadding="4" ForeColor="#333333" GridLines="Horizontal" 
                                     AllowPaging="True" onrowcancelingedit="CategoryGridView_RowCancelingEdit" 
                                     ...
                                     Width="870px" DataKeyNames="CatID" PageSize="8">
                                  <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                  <Columns>
                                      <asp:TemplateField Visible="False" HeaderText="CategoryID">
                                          <ItemTemplate>
                                              <asp:Label ID="CatID" runat="server" Text='<%# Eval("CatID") %>'></asp:Label>
                                          </ItemTemplate>
                                      </asp:TemplateField>
                                      ...
                                      <asp:TemplateField HeaderText="Image">
                                          <ItemTemplate>
                                              <asp:Image ID="CatImage" runat="server" Height="100px" 
                                                  ImageUrl='<%# Eval("Image") %>' Width="180px" />
                                          </ItemTemplate>
                                          <EditItemTemplate>                                           
                                                      <asp:AsyncFileUpload ID="CatImage" runat="server" Width="200px" />
                                      ...
                                      <asp:TemplateField HeaderText="Description">
                                          <ItemTemplate>
                                              <asp:TextBox ID="CatDesTextBox" runat="server" BorderStyle="None" 
                                                  Height="100px" ReadOnly="True" Text='<%# Eval("Description") %>' 
                                                  TextMode="MultiLine" Width="200px"></asp:TextBox>
                                          </ItemTemplate>
                                          <EditItemTemplate>
                                              <asp:TextBox ID="CatDesTextBox" runat="server" Height="100px" 
                                                  Text='<%# Eval("Description") %>' TextMode="MultiLine" Width="200px"></asp:TextBox>
                                          </EditItemTemplate>
                                          <ItemStyle Width="230px" />
                                      </asp:TemplateField>
                                  </Columns>
                                  ...
                                  <PagerStyle BackColor="#284775" ForeColor="White" HorizontalAlign="Center" 
                                      Height="10px" />
                                  <RowStyle BackColor="#F7F6F3" ForeColor="#333333" Font-Size="12pt" />
                      ...
                      <tr>
                          <td class="style4" bgcolor="#68A0E7">
                              <asp:Label ID="Label4" runat="server" Font-Size="12pt" Text="Name:"></asp:Label>
                          </td>
                          <td class="style4" bgcolor="#68A0E7">
                              <asp:TextBox ID="CatNameTextBox0" runat="server" Height="24px" Width="150px" 
                                  Font-Size="12pt"></asp:TextBox></td>
                          <td class="style4" bgcolor="#68A0E7">
                              <asp:Label ID="Label5" runat="server" Font-Size="12pt" Text="Image:"></asp:Label>
                          </td>
                          <td class="style4" bgcolor="#68A0E7">
                              <asp:AsyncFileUpload ID="CatImageFileUp0" runat="server" Width="220px" />
                          </td>
                          <td class="style4" bgcolor="#68A0E7">
                              <asp:Label ID="Label6" runat="server" Font-Size="12pt" Text="Description:"></asp:Label>
                          </td>
                          <td class="style4" rowspan="2" bgcolor="#68A0E7">
                              <asp:TextBox ID="CatDescriptionTextBox0" runat="server" Height="100px" TextMode="MultiLine" 
                                  Width="150px" Font-Size="12pt"></asp:TextBox>
                          </td>
                          <td bgcolor="#68A0E7">
                              
                              <asp:Button ID="AddCatbutton1" runat="server" Text="Add" Font-Size="12pt" style="margin-right: 0px" 
                                  onclick="AddCatButton1_Click" />
                          </td>
                      </tr>
                      <tr>
                          <td class="style4" bgcolor="#68A0E7">
    ...
    <div id="footer" class="span-24 last">
      <div>
        <a href="http://www.cardpool.com/about">About Us> 
