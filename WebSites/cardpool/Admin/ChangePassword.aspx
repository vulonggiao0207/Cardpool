<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChangePassword.aspx.cs" Inherits="how_it_works" %>
...
<body>
 ...
 <div id="main_nav" class="span-24 last">
	 <div id="Div1" class="span-24 last">
	<ul>
...
<!-- END vavigator-->  
   ...
   <table class="style1" 
             style="width: 400px; height: 110px; border: medium solid #68A0E7; margin: 100px auto 100px auto; background-color: #FFFFFF;">
          <tr>
              <td>
                  <table style="margin: 0px">
                      ...
                      <tr>
                          <td class="style3">
                              <asp:Label ID="Label1" runat="server" Text="Current password:" Font-Size="11pt"></asp:Label>
                          </td>
                          <td>
                              <asp:TextBox ID="PasswordTextBox" runat="server" Font-Size="12pt" 
                                  TextMode="Password" ValidationGroup="v1"></asp:TextBox>
                              <br />
                              <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                  ControlToValidate="PasswordTextBox" Display="Dynamic" 
                                  ErrorMessage="This field cannot be blanked" ForeColor="Red" 
                                  ValidationGroup="v1"></asp:RequiredFieldValidator>
                          </td>
                      </tr>
                      <tr>
                          <td class="style3">
                              <asp:Label ID="Label2" runat="server" Text="New password:" Font-Size="11pt"></asp:Label>
                          </td>
                          <td>
                              <asp:TextBox ID="NewPasswordTextBox" runat="server" Font-Size="12pt" 
                                  TextMode="Password" ValidationGroup="v1"></asp:TextBox>
                              <br />
                              <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                  ControlToValidate="NewPasswordTextBox" Display="Dynamic" 
                                  ErrorMessage="This field cannot be blanked" ForeColor="Red" 
                                  ValidationGroup="v1"></asp:RequiredFieldValidator>
                          </td>
                      </tr>
                      <tr>
                          <td class="style3">
                              <asp:Label ID="Label3" runat="server" Text="Confirm password:" Font-Size="11pt"></asp:Label>
                          </td>
                          <td>
                              <asp:TextBox ID="ConfirmPasswordTextBox" runat="server" Font-Size="12pt" 
                                  TextMode="Password" ValidationGroup="v1"></asp:TextBox>
                              <br />
                              ...
                              &nbsp;<asp:CompareValidator ID="CompareValidator1" runat="server" 
                                  ...
                                  ControlToValidate="ConfirmPasswordTextBox" Display="Dynamic" 
                                  ErrorMessage="Wrong comfirm password" ForeColor="Red" ValidationGroup="v1"></asp:CompareValidator>
                          </td>
                      </tr>
                      <tr>
                          <td class="style3">
                              &nbsp;</td>
                          <td>
                              <asp:Button ID="SaveButton" runat="server" Font-Size="12pt" Text="Save" 
                                  onclick="SaveButton_Click" ValidationGroup="v1" 
                                />
                          </td>
                      </tr>
                      <tr>
                          <td class="style2" colspan="2">
                              <asp:Label ID="WrongPassLabel" runat="server" Font-Bold="False" 
