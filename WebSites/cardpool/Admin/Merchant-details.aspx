<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Merchant-details.aspx.cs" Inherits="how_it_works" %>
...
<body>
    ...
    <div id="header" class="span-24 last">
      <table class="layout">
        <tbody><tr>
          ...
          <a href="http://www.cardpool.com/"><img alt="Cardpool - Gift Card Exchange" 
                    class="ie6_hack_png_fix" src="../images/logo_146x48.png" width="146" 
                    height="48"></a>            </div>
          </td>
  ...
  <div id="main_nav" class="span-24 last">
	<ul>
    <li><a href="Manage-user.aspx">Manage User</a>
	<li><a href="Manage-gift-card.aspx">Manage gift card</a></li>
	<li><a href="Manage-Orders.aspx">Manager order</a>
...
<!-- END vavigator-->  
       ...
       <div class="right" style="margin-right:30; float: right;">
	      ...
	      <table style="float: right">
              <tr>
                  <td>
                      <asp:LinkButton ID="HelloLabel" runat="server" Font-Size="10pt" 
                          onclick="HelloLabel_Click"></asp:LinkButton>
                       </td>
                  <td>
                      <asp:LinkButton ID="LogoutLink" runat="server" Font-Size="10pt" 
              onclick="LogoutLink_Click">,Log out</asp:LinkButton></td>
              </tr>
              </table>
	  </div>
    </div>   
   <!----------------------------------------------------------------------------->  
     <div id="main_content" class="span-24 last" style="background-color: #DDDDDD">
   <table class="style1" 
          
          
             
             
             style="width: 940px; height: 110px; border: medium groove #68A0E7; margin: 100px auto 100px auto; background-color: #FFFFFF;">
          <tr>
              <td>
                  <table style="width: 920px; margin: 0px; overflow: f;">
                      <tr>
                          <td colspan="2">
                          <hr style="padding: 0px; margin: 0px" />
                            <h2 style="margin: 0px">  Merchant details </h2>
                             <hr style="padding: 0px; margin: 0px" />   
                      ...
                      <tr>
                          <td colspan="2" bgcolor="#DDDDDD">
                              <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                  <ContentTemplate>
                                      <center>
                                          <table bgcolor="#DDDDDD" 
                                              style="border: medium solid #68A0E7; margin: 0px; width: 400px;">
                                              <tr>
                                                  <td>
                                                      <asp:Label ID="Label4" runat="server" Font-Size="12pt" Text="Category"></asp:Label>
                                                  </td>
                                                  <td>
                                              ...
                                              <tr>
                                                  <td>
                                                      <asp:Label ID="Label3" runat="server" Font-Size="12pt" Text="Merchant name:"></asp:Label>
                                                  </td>
                                                  <td>
                                                      <asp:DropDownList ID="MerchantDropDownList" runat="server" AutoPostBack="True" 
                                                          Font-Size="12pt" 
                                                          onselectedindexchanged="MerchantDropDownList_SelectedIndexChanged" 
                                                          Width="200px">
                                                      </asp:DropDownList>
                                                  </td>
                                              </tr>
                                              <tr>
                                                  <td>
                                                      <asp:Label ID="Label5" runat="server" Font-Size="12pt" Text="Image:"></asp:Label>
                                                  </td>
                                                  <td rowspan="2">
                                                      <asp:Image ID="MerchantImage" runat="server" Height="100px" Width="180px" />
                                                  </td>
                                              </tr>
                                              <tr>
                                                  <td>
                                              ...
                                              <tr>
                                                  <td>
                                                      <asp:Label ID="Label6" runat="server" Font-Size="12pt" Text="Description"></asp:Label>
                                                  </td>
                                                  <td rowspan="2">
                                                      <asp:TextBox ID="MechantDescriptionTextBox" runat="server" Height="100px" 
                                                          ReadOnly="True" TextMode="MultiLine" Width="220px"></asp:TextBox>
                                                  </td>
                                              </tr>
                                              <tr>
                                                  <td>
                                  ...
                                  <Triggers>
                                      <asp:AsyncPostBackTrigger ControlID="MerchantDropDownList" 
                      ...
                      <tr bgcolor="#68A0E7">
                          ...
                          <ContentTemplate>
                              <table style="margin: 0px">
                                  <tr>
                                      <td>
                                          <asp:Label ID="Label7" runat="server" Font-Size="12pt" Text="Value:"></asp:Label>
                                      </td>
                                      <td class="style3" style="padding: 0px">
                                          <asp:TextBox ID="ValueTextBox" runat="server" Font-Size="12pt" Width="50px" 
                                              ValidationGroup="valid0"></asp:TextBox>
                                          <asp:Label ID="Label11" runat="server" Font-Size="12pt" Text="$"></asp:Label>
                                          <br />
                                          <asp:CompareValidator ID="CompareValidator1" runat="server" 
                                              ControlToValidate="ValueTextBox" ErrorMessage="Only number" ForeColor="#CC3300" 
                                              Operator="DataTypeCheck" Type="Double" ValidationGroup="valid0" 
                                              ViewStateMode="Disabled" Display="Dynamic"></asp:CompareValidator>
                                      </td>
                                      <td>
                                          <asp:Label ID="Label8" runat="server" Font-Size="12pt" Text="Pay:"></asp:Label>
                                      </td>
                                      <td class="span-5" style="padding: 0px">
                                          <asp:TextBox ID="PayTextBox" runat="server" Font-Size="12pt" Width="50px" 
                                              ValidationGroup="valid0"></asp:TextBox>
                                          <asp:Label ID="Label12" runat="server" Font-Size="12pt" Text="$"></asp:Label>
                                          <br />
                                          <asp:CompareValidator ID="CompareValidator2" runat="server" 
                                              ControlToValidate="PayTextBox" ErrorMessage="Only number" ForeColor="#CC3300" 
                                              Operator="DataTypeCheck" Type="Double" ValidationGroup="valid0" 
                                              ViewStateMode="Disabled" Display="Dynamic"></asp:CompareValidator>
                                      </td>
                                      <td class="style6">
                                          <asp:Label ID="Label9" runat="server" Font-Size="12pt" Text="Save:"></asp:Label>
                                      </td>
                                      <td class="style5">
                                          <asp:TextBox ID="SaveTextBox" runat="server" Font-Size="12pt" Width="50px" 
                                              ValidationGroup="valid0"></asp:TextBox>
                                          <asp:Label ID="Label13" runat="server" Font-Size="12pt" Text="%"></asp:Label>
                                          <br />
                                          <asp:CompareValidator ID="CompareValidator3" runat="server" 
                                              ControlToValidate="SaveTextBox" ErrorMessage="Only number" ForeColor="#CC3300" 
                                              Operator="DataTypeCheck" Type="Double" ValidationGroup="valid0" 
                                              ViewStateMode="Disabled" Display="Dynamic"></asp:CompareValidator>
                                      </td>
                                      <td>
                                          <asp:Label ID="Label10" runat="server" Font-Size="12pt" Text="Notes:"></asp:Label>
                                      </td>
                                      <td style="width: 170px">
                                          <asp:TextBox ID="NotesTextBox" runat="server" Font-Size="12pt" Height="50px" 
                                              TextMode="MultiLine" Width="150px" ValidationGroup="valid0"></asp:TextBox>
                                      </td>
                                  </tr>
                              </table>
                              </ContentTemplate>
                              <Triggers>
                                  <asp:AsyncPostBackTrigger ControlID="AddMerChantDetailButton" 
                                      EventName="Click" />
                              </Triggers>
                              </asp:UpdatePanel>
                          ...
                          <td>
                              <asp:Button ID="AddMerChantDetailButton" runat="server" Font-Size="12pt" 
                                  Text="Add new merchant details..." Width="200px" 
                                  onclick="AddMerChantDetailButton_Click" ValidationGroup="valid0"/>
                          </td>
                      </tr>
                      <tr>
                          ...
                          <hr style="padding: 0px; margin: 0px" />
                              <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                  <ContentTemplate>
                                  <center>
                                         <asp:GridView ID="MerchantDetailsGridView" runat="server" AllowPaging="True" 
                                          AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" CellPadding="4" 
                                          Font-Size="12pt" ForeColor="#333333" GridLines="None" PageSize="8" 
                                          Width="920px" AutoGenerateColumns="False" DataKeyNames="MerchantID" 
                                          onrowcancelingedit="MerchantDetailsGridView_RowCancelingEdit" 
                                          onrowdeleting="MerchantDetailsGridView_RowDeleting" 
                                          onrowediting="MerchantDetailsGridView_RowEditing" 
                                          onrowupdating="MerchantDetailsGridView_RowUpdating" 
                                             onpageindexchanging="MerchantDetailsGridView_PageIndexChanging">
                                          ...
                                          <Columns>
                                              ...
                                              <asp:BoundField DataField="Save" HeaderText="Save">
                                              <ItemStyle Width="140px" />
                                              </asp:BoundField>
                                  ...
                                  <Triggers>
                                      ...
                                      <asp:AsyncPostBackTrigger ControlID="AddMerChantDetailButton" 
                                          EventName="Click" />
                                      <asp:AsyncPostBackTrigger ControlID="AddMerChantDetailButton1" 
                                          EventName="Click" />
                                  </Triggers>
                              </asp:UpdatePanel>
                              <hr style="padding: 0px; margin: 0px" />
                      ...
                      <tr bgcolor="#68A0E7">
                          <td class="style2">
                              ...
                              <table style="margin: 0px">
                                  <tr>
                                      <td>
                                          <asp:Label ID="Label14" runat="server" Font-Size="12pt" Text="Value:"></asp:Label>
                                      </td>
                                      <td class="style3" style="padding: 0px">
                                          <asp:TextBox ID="ValueTextBox0" runat="server" Font-Size="12pt" Width="50px" 
                                              ValidationGroup="valid1"></asp:TextBox>
                                          <asp:Label ID="Label15" runat="server" Font-Size="12pt" Text="$"></asp:Label>
                                          <br />
                                          <asp:CompareValidator ID="CompareValidator4" runat="server" 
                                              ControlToValidate="ValueTextBox0" ErrorMessage="Only number" 
                                              ForeColor="#CC3300" Operator="DataTypeCheck" Type="Double" 
                                              ValidationGroup="valid1" ViewStateMode="Disabled" Display="Dynamic"></asp:CompareValidator>
                                      </td>
                                      <td>
                                          <asp:Label ID="Label16" runat="server" Font-Size="12pt" Text="Pay:"></asp:Label>
                                      </td>
                                      <td class="span-5" style="padding: 0px">
                                          <asp:TextBox ID="PayTextBox0" runat="server" Font-Size="12pt" Width="50px" 
                                              ValidationGroup="valid1"></asp:TextBox>
                                          <asp:Label ID="Label17" runat="server" Font-Size="12pt" Text="$"></asp:Label>
                                          <br />
                                          <asp:CompareValidator ID="CompareValidator5" runat="server" 
                                              ControlToValidate="PayTextBox0" ErrorMessage="Only number" ForeColor="#CC3300" 
                                              Operator="DataTypeCheck" Type="Double" ValidationGroup="valid1" 
                                              ViewStateMode="Disabled" Display="Dynamic"></asp:CompareValidator>
                                      </td>
                                      <td class="style6">
                                          <asp:Label ID="Label18" runat="server" Font-Size="12pt" Text="Save:"></asp:Label>
                                      </td>
                                      <td class="style5">
                                          <asp:TextBox ID="SaveTextBox0" runat="server" Font-Size="12pt" Width="50px" 
                                              ValidationGroup="valid1"></asp:TextBox>
                                          <asp:Label ID="Label19" runat="server" Font-Size="12pt" Text="%"></asp:Label>
                                          <br />
                                          <asp:CompareValidator ID="CompareValidator6" runat="server" 
                                              ControlToValidate="SaveTextBox0" ErrorMessage="Only number" ForeColor="#CC3300" 
                                              Operator="DataTypeCheck" Type="Double" ValidationGroup="valid1" 
                                              ViewStateMode="Disabled" Display="Dynamic"></asp:CompareValidator>
                                      </td>
                                      <td>
                                          <asp:Label ID="Label20" runat="server" Font-Size="12pt" Text="Notes:"></asp:Label>
                                      </td>
                                      <td style="width: 170px">
                                          <asp:TextBox ID="NotesTextBox0" runat="server" Font-Size="12pt" Height="50px" 
                                              TextMode="MultiLine" Width="150px" ValidationGroup="valid1"></asp:TextBox>
                                      </td>
                                  </tr>
                              </table>
                              </ContentTemplate>
                          ...
                          <td>
                              <asp:Button ID="AddMerChantDetailButton1" runat="server" Font-Size="12pt" 
                                  Text="Add new merchant details..." Width="200px"
                                  onclick="AddMerChantDetailButton1_Click" ValidationGroup="valid1" 
                                  />
                          </td>
                      </tr>
                      </table>
  ...
  <div class="shadow_box">
    ...
    <div class="box_middle"><div class="content">
      ...
      <hr>
        <div style="margin:0;padding:0;display:inline"><input name="authenticity_token" value="pHzpAzpbCzETmLdiy1xIJtgZwyrW10/5hfboKI0TMU8=" type="hidden"></div>        <table class="layout">
          <tbody><tr>
            <td>
