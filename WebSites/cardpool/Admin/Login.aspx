<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="how_it_works" %>
...
<!-- END vavigator-->  
   ...
   <table class="style1" 
             ...
             style="width: 300px; height: 110px; border: medium solid #68A0E7; margin: 100px auto 100px auto; background-color: #FFFFFF;">
          <tr>
              <td>
                  <table style="margin: 0px">
                      ...
                      <tr>
                          <td>
                              <asp:Label ID="Label1" runat="server" Text="ID:" Font-Size="11pt"></asp:Label>
                          </td>
                          <td>
                      ...
                      <tr>
                          <td>
                              <asp:Label ID="Label2" runat="server" Text="Password:" Font-Size="11pt"></asp:Label>
                          </td>
                          <td>
                      ...
                      <tr>
                          <td class="style2">
                              &nbsp;</td>
                          <td>
                              <asp:Button ID="LoginButton" runat="server" Font-Size="12pt" Text="Login" 
                      ...
                      <tr>
                          <td class="style2" colspan="2">
                              <asp:Label ID="WrongPassLabel" runat="server" Font-Bold="False" 
                                  Font-Size="11pt" ForeColor="Red" Text="Wrong password! Please try again" 
