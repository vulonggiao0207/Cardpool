<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gift-cards-for-amazon-gift-card.aspx.cs" Inherits="gift_cards_for_amazon_gift_card" %>
...
<h1>
Exchange your gift cards for a new Amazon.com Gift Card*,
<a href="/sell-gift-cards">cash, or other valuable items</a>
.
</h1>
<h3>
...
<img width="150" src="images/amazon_gift_card.jpg" 
        alt="Exchange Gift Cards For Amazon.com Gift Card">
</td>
<td>
<table class="giftcards_big_grid bottom">
<tbody>
...
<a href="/press">
<img src="images/press_bar.png" alt="Press_bar">
</a>
</div>
...
<div class="header">Sell Gift Card</div>
</div>
</div>
<div class="box_middle_right">
<div class="box_middle_left">
...
<form id="new_card" class="new_card" method="post" action="/sell-card">
<div style="margin:0;padding:0;display:inline">
<input type="hidden" value="fLnq4bO04eVy/f2qxn1dm7bFMixX96l3YOxn8T6ablc=" name="authenticity_token">
</div>
<table class="bottom">
<tbody>
<tr>
<td>
    Merchant
<br>
<select id="card_merchant_id" class="input_large_300 merchant_select" name="card[merchant_id]">
<option value=""></option>
...
<option value="95">Ticketmaster</option>
...
<option value="230">Zumiez</option>
</select>
<br>
(Don't see your merchant?
<a class="merchant_request_link" href="#">Let us know!</a>
)
</td>
</tr>
<tr>
...
<label for="card_value">Current Value</label>
<br>
<input id="card_value" class="input_large_200" type="text" size="30" name="card[value]">
<br>
</td>
</tr>
<tr>
...
(
<a id="show_locate_pin" class="show_locate_pin">Where can I find the PIN?</a>
)
<br>
</div>
<div id="locate_pin" class="blue_box" style="display: none">
<img height="120" src="/scaled_images/common/x120/back_of_gift_card_1_x120.png?1327747420" alt="Diagram of card number and PIN">
<img height="120" src="/scaled_images/common/x120/back_of_gift_card_2_x120.png?1327747420" alt="Diagram of card number and PIN">
</div>
<div class="raised_box">
<div class="box_top_right">
<div class="box_top_left"></div>
...
<div class="box_middle_right">
<div class="box_middle_left">
<div class="content_tiny_extra_padding">
<input id="card_has_pin_yes" type="radio" value="yes" name="card[has_pin]">
<label for="card_has_pin_yes">Yes</label>
<input id="card_has_pin_no" type="radio" value="no" name="card[has_pin]">
<label for="card_has_pin_no">No</label>
<input id="card_has_pin_notsure" type="radio" value="notsure" name="card[has_pin]" checked="checked">
<label for="card_has_pin_notsure">Not Sure</label>
<br>
</div>
</div>
</div>
...
<tr>
<td>
<span class="blue_button submit_button bottom" style="width: 95px;">
<a href="/sell-gift-cards">
<span class="button_right" style="cursor: pointer;">
<span class="button_left">
<span class="button_text" style="background-color: #315586">Get Offer</span>
</span>
</span>
</a>
</span>
...
<div class="box_middle_left">
<div class="content">
<p> Have unused gift cards? Cardpool gives you an easy way to sell gift cards for cash and other valuable items. </p>
<p>
Selling more than $5,000 in gift cards? Learn about
<a href="/bulk-seller-program">Bulk Sales</a>
.
</p>
<hr>
<p>
<strong>Step 1: Get Offers</strong>
<br>
Tell us which gift cards you'd like to sell for cash.
</p>
<p>
<strong>Step 2: Transfer Gift Cards</strong>
<br>
Sell your gift cards electronically - no mailing required, or mail your gift cards using our FREE SHIPPING LABEL.
</p>
<p>
<strong>Step 3: Get Paid</strong>
<br>
We'll send you a check within 24 hours of receiving your gift cards.
</p>
<p class="bottom">
Questions? To learn more about selling gift cards,
<a href="/support/how-it-works">click here</a>
.
</p>
</div>
</div>
